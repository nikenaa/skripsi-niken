            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/data_siswa') }}">Students</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h3 class="card-title font-16 mt-0">Form Add Students</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-responsive nowrap">
                                    ...
                                    <tbody id="tbody-data-siswa">
                                        <tr>
                                            <td><input type="text" name="no_induk[]" placeholder="Nomor Induk Siswa" style="border: none; background: transparent; text-align: center;" autocomplete="off" required></td>
                                            ...
                                            <td>
                                                <select name="kelas_id[]" style="border: none; background: transparent; text-align: center;">
                                ...
                                <a href="{{ url('/data_siswa') }}" class="btn btn-outline-warning mt-3">Back</a>
