            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/data_kelas') }}">Kelas</a></li>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h3 class="card-title font-16 mt-0">Form Tambah Kelas</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped nowrap" style="width: 100%">
                                    ...
                                    <tbody id="tbody-data-kelas">
                                        <tr>
                                            <td><input type="text" name="nama[]" placeholder="Nama Kelas" style="border: none; background: transparent; text-align: center;" autocomplete="off" required></td>
                                            <td></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <a href="{{ url('/data_kelas') }}" class="btn btn-outline-warning mt-3">Back</a>
    ...
    // HAPUS ROW
        ...
        $('.tambah-baris-kelas').click(function() {
            var baru = `
                <tr>
                    <td>
                        <input type="text" name="nama[]" placeholder="Nama Kelas" style="border: none; background: transparent; text-align: center;" autocomplete="off" required>
                    </td>
                    <td>
